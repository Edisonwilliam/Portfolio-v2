  ...
  return (
    <div className="fixed top-6 md:top-8 left-0 right-0 z-50 flex justify-center px-4">
      <motion.nav
        ...
        className="flex items-center gap-0.5 md:gap-1 p-1 bg-white/60 dark:bg-black/80 backdrop-blur-xl rounded-full border border-zinc-200/50 dark:border-zinc-800/80 shadow-2xl shadow-black/10"
      >
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "group relative flex items-center gap-2 px-2.5 py-1.5 md:px-3 md:py-2 rounded-full transition-all duration-300",
                isActive
            ...
            >
              ...
              <motion.span
                ...
                className="overflow-hidden whitespace-nowrap text-sm font-medium hidden md:inline-block"
              >
                {item.label}
              </motion.span>
              {isActive && (
